...
public class MovieDbEntity extends SugarRecord implements Parcelable {

    public static final String TABLE_NAME = "MOVIE_DB_ENTITY";
    ...
    public MovieDbEntity(String title,
                         String overview,
                         String release_date,
                         String genre_ids,
                         Double popularity,
    ...
    public static final Creator<MovieDbEntity> CREATOR = new Creator<MovieDbEntity>() {
        @Override
        public MovieDbEntity createFromParcel(Parcel source) {
            return new MovieDbEntity(source);
        }

        @Override
        public MovieDbEntity[] newArray(int size) {
            return new MovieDbEntity[size];
        }
    };
}
